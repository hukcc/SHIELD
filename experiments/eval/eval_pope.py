...
parser.add_argument("--gt_files", type=str, default="experiments/data/POPE/coco/coco_pope_random.json")
parser.add_argument("--gen_files", type=str, default="logs/llava/pope-coco/random.jsonl")
